 ...
 */
 ...
 export const findType = () => {
   const thisThing = typeof thing;
   if (thisThing === "string") 
     return "This is a string";
   else if (thisThing === "number") 
     return "This is a number";
   else if (thisThing === "boolean") 
 ...
 export const getIsValidOnNameTag = () => {
   ...
   const isCap = (nameTagOption.substring(0,1) === nameTagOption.toUpperCase()? true : false);
   const isLength = (nameTagOption.length < 8 ? true : false );
   return (isCap && isLength? true : false);
   // Write your code here
 };
 ...
 export const convertStringToNumber = () => {
   const stringNumber = parseFloat(stringToConvert);
   return stringNumber;
   // Write your code here
 };
 ...
 export const getHasUppercaseLetters = () => {
   const regex = /([A-Z])/g;                                             //what is regex
