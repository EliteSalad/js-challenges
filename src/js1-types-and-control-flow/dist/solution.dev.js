...
var getIsValidOnNameTag = function getIsValidOnNameTag() {
  var firstLetterOfName = nameTagOption.substring(0, 1);
  var isValidName = nameTagOption.length <= 8 && firstLetterOfName === firstLetterOfName.toUpperCase();
  return isValidName;
};
/* Advanced Challenges */
...
var convertStringToNumber = function convertStringToNumber() {
  var convertedString = parseFloat(stringToConvert);
...
var getHasUppercaseLetters = function getHasUppercaseLetters() {
  var regex = /([A-Z])/g;
  var hasUpperCaseLetters = regex.test(stringWithUppercaseLetters);
...
var convertPascalCaseToSnakeCase = function convertPascalCaseToSnakeCase() {
  var splitWords = pascalCaseVariableName.split(/(?=[A-Z])/);
  var joinedWordsWithUnderscores = splitWords.join("_");
  var snakeCase = joinedWordsWithUnderscores.toLowerCase();
  return snakeCase;
};

exports.convertPascalCaseToSnakeCase = convertPascalCaseToSnakeCase;
//# sourceMappingURL=solution.dev.js.map
